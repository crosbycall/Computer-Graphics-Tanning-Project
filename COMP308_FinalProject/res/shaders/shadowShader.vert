...
void main()
{
	...
	float uMapped = mapRanges(0, 1, -1, 1, gl_MultiTexCoord0.x);
	float vMapped = mapRanges(0, 1, -1, 1, gl_MultiTexCoord0.y);

	gl_Position = vec4(uMapped, vMapped, 0, 1.0); //UV coord position
